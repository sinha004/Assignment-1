  ...
  return (
    <div className="bg-amber-50 min-h-screen">
      ...
      <main className="p-4">
        ...
        <h2 className="url-3xl font-semibold">You can use <a className="text-red-500" href="https://www.google.com/">https://www.google.com/</a> for the URL as it will not take anything else than a valid URL</h2>
